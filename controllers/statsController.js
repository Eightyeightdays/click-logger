...
exports.getAll1 = (req, res)=>{
    Click1.find()
    .then(clicks => res.status(200).json({link1: clicks}))
    .catch(error => res.status(400).json({error}))
}
exports.getAll2 = (req, res)=>{
    Click2.find()
    .then(clicks => res.status(200).json({link2: clicks}))
    .catch(error => res.status(400).json({error}))
}
exports.getAll3 = (req, res)=>{
    Click3.find()
    .then(clicks => res.status(200).json({link3: clicks}))
    .catch(error => res.status(400).json({error}))
}
exports.getAll4 = (req, res)=>{
    Click4.find()
    .then(clicks => res.status(200).json({link4: clicks}))
    .catch(error => res.status(400).json({error}))
}
exports.getAll5 = (req, res)=>{
    Click5.find()
    .then(clicks => res.status(200).json({link5: clicks}))
    .catch(error => res.status(400).json({error}))
}
exports.getAll6 = (req, res)=>{
    Click6.find()
    .then(clicks => res.status(200).json({link6: clicks}))
    .catch(error => res.status(400).json({error}))
}